...
def get_table(tr_list:list, location:str) -> list:
  """
...
def table_to_dict(table:list) -> dict:
  """
  Takes the list of lists generated by get_table() and returns a dictionary
  
  Args:
  table (list): list of lists of columnar data generated by get_table()
